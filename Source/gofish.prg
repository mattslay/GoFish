...
*just create
		...
		otherwise
*Folder not found
			m.tcFolder = Getdir(m.tcFolder,'Local GoFish config folder not found. Please pick one.','',64+1+32+2+8)
			If Empty(m.tcFolder) Then
*No folder selected, we keep normal GoFish mode of operation
				tlFound = NIL
